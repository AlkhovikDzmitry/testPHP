...
<html xmlns="http://www.w3.org/1999/xhtml">
           ...
           <div id="wrap2">
               <div id="topbar">
                   <img style="float:left;margin:0 150px 0 20px;height:65px;" src="images/logo.svg" alt="logo"> 
                       <h1 id="sitename"><a href="index.html@page=1.html#">Тестовое задание</a> <span class="description"></span></h1>
               </div>
               <div id="header">
                   <div id="headercontent"> </div>
                   <div id="topnav">
                       <ul class="lavaLampWithImage" id="1">
                           <li class='current' ><a href="index.html@page=1.php">Города</a></li>
                           <li  ><a href="index.html@page=2.php">Пользователи</a></li>
                   ...
                   <div id="left">   
                       <div class="post">
                           ...
                           <div class="postcontent"> 
                               ...
                               <h2>Общее количество загрузок страницы = <b> </b><?php echo $counter; ?></h2>
                           </div>
                           <div class="postbottom">
                               <h3 style=" margin-left: 25px; ">Вы посещали эту страницу <b> <?php echo $counter; ?></b> раз</h3>
                           </div>
                       </div>
                       <div class="post">
   <div class="postheader"> </div>
   <div class="postcontent"> 
       ...
       <!--вывод таблицы Города-->
           ...
           <form action="index.html@page=1.php" method="post"   >
