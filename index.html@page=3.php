            ...
            <div id="wrap2">
                <div id="topbar">
                    <img style="float:left;margin:0 150px 0 20px;height:65px;" src="images/logo.svg" alt="logo"> 
                        <h1 id="sitename"><a href="index.html@page=3.html#">Тестовое задание</a> <span class="description"></span></h1>
                </div>
                <div id="header">
                    ...
                    <div id="topnav">
                        <ul class="lavaLampWithImage" id="1">
                            ...
                            <li class='current' ><a href="index.html@page=3.php">Поиск</a></li>
                        </ul>
                    </div>
                </div>
                <div id="content">
                    <div id="left">   
                        <div class="post">
                            ...
                            <div class="postcontent"> 
                                <h2>Общее количество загрузок страницы = <b>3</b><?php echo $counter; ?></h2>
                            </div>
                            <div class="postbottom">
                                <h3 style=" margin-left: 25px; ">Вы посещали эту страницу <b>
                                <?php echo $counter; ?> </b> раз</h3>
                            </div>
                        </div>
                        
<!--форма для поиска по имени и фамилии-->
<form action="index.html@page=3.php" method="post">
    <div class='form'>
